...
class Game:
    ...
    def update(self):
        ...
        if hits2:
            if self.square.vel.x!=0:
                vel.x = -self.square.vel.x
            else:
                vel.x= self.player.vel.x
    ...
    def textobj(text, font):
        ...
        return textsurf, textsur.get_rect()

    def draw_text(self, text, size, color, x, y):
        Ltext = pg.font.Font(self.font_name, 80)
        textsurf, textrect= textobj (text, Ltext)
